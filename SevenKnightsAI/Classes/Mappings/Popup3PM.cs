...
namespace SevenKnightsAI.Classes.Mappings
{
    class Popup3PM
    {
        ...
        public static readonly PixelMapping Exclucsive = new PixelMapping //exclusive sell top
        {
            X = 100,
            Y = 15,
            Color = 16736352,
        ...
        public static readonly PixelMapping ExclusivePic = new PixelMapping //crystal above eye eieleen
        {
            X = 159,
            Y = 138,
            Color = 15133684,
